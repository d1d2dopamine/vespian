...
public fun LatStepper(
    ...
    Row(
        ...
        LatText(
            ...
            color = Lattice.colors.ink.copy(alpha = if (enabled) 1f else Alpha.disabled),
            maxLines = 1,
        )
        LatButton(
            label = "+",
