...
/** Material's colour-slot names, answered from the Lattice palette. */
public class CompatColorScheme internal constructor() {
    /** The accent. The one colour that is allowed to be a colour. */
    public val primary: Color @Composable @ReadOnlyComposable get() = Lattice.colors.accent
    public val secondary: Color @Composable @ReadOnlyComposable get() = Lattice.colors.accent
    public val tertiary: Color @Composable @ReadOnlyComposable get() = Lattice.colors.accent

    /** The page. Not a tonal surface: the actual background of the app. */
    public val background: Color @Composable @ReadOnlyComposable get() = Lattice.colors.background
     ...
     */
    public val surface: Color @Composable @ReadOnlyComposable get() = Lattice.colors.panel
    public val surfaceVariant: Color @Composable @ReadOnlyComposable get() = Lattice.colors.panel
    public val surfaceContainer: Color @Composable @ReadOnlyComposable get() = Lattice.colors.panel
    public val surfaceContainerHigh: Color @Composable @ReadOnlyComposable get() = Lattice.colors.panel
    public val surfaceContainerLow: Color @Composable @ReadOnlyComposable get() = Lattice.colors.panel

    /** Body text. */
    public val onBackground: Color @Composable @ReadOnlyComposable get() = Lattice.colors.ink
    public val onSurface: Color @Composable @ReadOnlyComposable get() = Lattice.colors.ink
     ...
     */
    public val onSurfaceVariant: Color @Composable @ReadOnlyComposable get() = Lattice.colors.muted

    /** Text on top of the accent, and on top of anything filled with ink. */
    public val onPrimary: Color @Composable @ReadOnlyComposable get() = Lattice.colors.onAccent
    public val onSecondary: Color @Composable @ReadOnlyComposable get() = Lattice.colors.onAccent
    public val onTertiary: Color @Composable @ReadOnlyComposable get() = Lattice.colors.onAccent

    /** Rules and borders. Both outline slots are the same hairline. */
    public val outline: Color @Composable @ReadOnlyComposable get() = Lattice.colors.line
    public val outlineVariant: Color @Composable @ReadOnlyComposable get() = Lattice.colors.line
     ...
     */
    public val error: Color @Composable @ReadOnlyComposable get() = Lattice.colors.danger
    public val onError: Color @Composable @ReadOnlyComposable get() = Lattice.colors.onDanger
    public val errorContainer: Color @Composable @ReadOnlyComposable get() = Lattice.colors.background
    public val onErrorContainer: Color @Composable @ReadOnlyComposable get() = Lattice.colors.danger

    /** Never used for a scrim over content; here so old call sites compile. */
    public val scrim: Color @Composable @ReadOnlyComposable get() = Lattice.colors.background
    public val inverseSurface: Color @Composable @ReadOnlyComposable get() = Lattice.colors.ink
    public val inverseOnSurface: Color @Composable @ReadOnlyComposable get() = Lattice.colors.background
}
 ...
 *
 * The names are Material's; the values come from [Lattice]. Nothing here reads a
...
public object MaterialTheme {
    ...
    public val typography: LatTypography
        @Composable @ReadOnlyComposable get() = Lattice.typography
...
/**
 * Material's Text, with the same parameter list, drawn by [LatText].
 *
