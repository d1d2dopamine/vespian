// ---------------------------------------------------------------------------
// Lattice: the design system as its own Android library module.
//
...
// compiler plugin are resolved once for the whole build, so app/ and lattice/
