 ...
 * the platform sans until a face is chosen, and [Trial3Typography.withFont] applies
...
@Immutable
public data class Trial3Typography(
     ...
     */
    public fun withFont(family: FontFamily?): Trial3Typography {
        if (family == null) return this
        fun TextStyle.f() = this.copy(fontFamily = family)
        return Trial3Typography(
